...
> Source of truth for product intent. Captured verbatim from the originating ChatGPT design session
> (share link provided 2026-08-16). Do not edit this file to reflect implementation drift — it records
> what the product owner specified. Amendments belong in a dated addendum below the spec body.
